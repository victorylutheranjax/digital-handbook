...
hero:
  ...
  actions:
    - theme: brand
      text: Latest Guide
      link: /worship/worship-slides
    - theme: alt
      text: Changelog
      link: /changelog
features:
  - icon:
      dark: /dark-app-window.svg
      light: /light-app-window.svg
      width: 36
      height: 36
  ...
  - icon:
      dark: /dark-monitor-play.svg
      light: /light-monitor-play.svg
      width: 36
      height: 36
  ...
  - icon:
      dark: /dark-book-open-text.svg
      light: /light-book-open-text.svg
      width: 36
      height: 36
